            ...
            <section class="tc-projects-style2">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <h2 class="fsz-45 fw-500"> Project <span class="sub-font fst-italic color-orange1 fw-400"> Malhar </span> </h2>
                        </div>
                    </div>
                    <div class="tabs-links mt-40">
                        ...
                        <div class="text color-666" style="line-height: 40px;">
                            <h6> 
                            Refurbishment of 3 storey villa<br/><br/>
                ...
                @php
    $projects = '[
        {"image":"/GALLERY-2024/MALHAR VILLA 3DS/1.jpg"},
        {"image":"/GALLERY-2024/MALHAR VILLA 3DS/2.jpg"},
        {"image":"/GALLERY-2024/MALHAR VILLA 3DS/3.jpg"},
        {"image":"/GALLERY-2024/MALHAR VILLA 3DS/4.jpg"}
    ]';
