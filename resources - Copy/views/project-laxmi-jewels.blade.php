            ...
            <section class="tc-projects-style2">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <h2 class="fsz-45 fw-500"> Project <span class="sub-font fst-italic color-orange1 fw-400"> Laxmi Jewels </span> </h2>
                        </div>
                    </div>
                    <div class="tabs-links mt-40">
                        ...
                        <div class="text color-666" style="line-height: 40px;">
                            <h6> 
                            Corporate office of a luxury jewellery brand <br/><br/>
                            Area: 6000 Sq Ft<br/><br/>
                            Design Concept: Classical Luxurious<br/><br/>
                            Project Designer: Artist Prasad Shetty<br/><br/>
                            </h6>
                        </div>
                    </div>
                </div>
