...
<head>
    ...
    <!-- Title  -->
    <title>Privacy Policy - Akar Interiors Turnkey Solutions</title>
                                        ...
                                        <div class="accordion-item">
                                            <div id="collapseTwo" class="accordion-collapse collapse show" data-bs-parent="#accordionProcess">
                                                <div class="accordion-body pt-4 pr-3">
                                                    ...
                                                    <li>
                                                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Akar Interiors Turnkey Solutions, B/601, Minoo Minar, Veera Desai Road, Andheri (West), Mumbai 400058.</p>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                    <p><strong>Website</strong> refers to Akar Interiors, accessible from <a href="https://akarinteriors.com" rel="external nofollow noopener" target="_blank">https://akarinteriors.com</a></p>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <ul>
                                                    <li>
                                                    <p>By email: admin@akarinteriors.com</p>
                                                    </li>
                                                    <li>
                                                    <p>By phone number: +918080380031</p>
                                                    </li>
                                                    </ul>
                                                    </div>
